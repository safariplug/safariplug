...
export default async function TravelRefundReviewPage() {
  ...
  const [hotelResult, transferResult, activityResult, reviewResult] = await Promise.all([
    supabaseAdmin
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <header className="mt-6 border-b border-zinc-800 pb-7">
          <p className="font-mono text-[11px] font-bold uppercase tracking-[.22em] text-emerald-400">
            Finance OS / Travel refunds
          </p>
          <h1 className="mt-2 text-4xl font-bold">Refund review center</h1>
          <p className="mt-3 max-w-3xl text-sm leading-6 text-zinc-400">
            Paid hotel, transfer and activity bookings that may require a refund are reviewed here.
            This workflow records finance review state only. It never issues an M-Pesa reversal or changes payment truth by itself.
          </p>
        </header>
        ...
        <section className="mt-8">
          ...
          {!pending.length ? (
            <div className="mt-5 rounded-2xl border border-zinc-800 bg-zinc-950 p-8 text-sm text-zinc-500">
              No travel refund cases currently require review.
            </div>
          ) : (
