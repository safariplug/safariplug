  ...
  return (
    <main className="min-h-screen bg-black p-8 font-sans text-white selection:bg-amber-500 selection:text-black md:p-12">
      <div className="mx-auto max-w-7xl">
        ...
        {activeTab === "events" && <div className="grid grid-cols-1 gap-6 md:grid-cols-2"><ModuleCard label="Curation Engine" title="Event Discovery & Approval" description="Review AI-discovered experiences, verify details, approve listings, or manage sponsored slots." href="/admin/ai-events" action="Open Curation Dashboard" /><ModuleCard label="Amani Studio" title="Marketing Studio" description="Generate high-conversion promotional copies for Instagram, WhatsApp, and newsletters from approved events." href="/admin/marketing" action="Open Marketing Studio" /><ModuleCard label="Partner inventory" title="Aurelian Integration" description="Map approved SafariPlug experiences to Aurelian inventory tracking. Outbound push stays disabled until the Aurelian API contract is documented." href="/admin/integrations" action="Open Aurelian Foundation" /><ModuleCard label="Hotel connectivity" title="Hotel Provider Adapters" description="Provider-agnostic hotel search/quote/hold/confirm contracts. No live supplier. Public /api/v1/hotels reports not-configured rather than fake inventory." href="/admin/integrations/hotels" action="Open Hotel Foundation" /><ModuleCard label="Transfer connectivity" title="Transfer Provider Adapters" description="Provider-agnostic airport and point-to-point transfer contracts. No live supplier. GET /api/v1/transfers/search reports not-configured rather than fake vehicles." href="/admin/integrations/transfers" action="Open Transfer Foundation" /><ModuleCard label="Driver marketplace" title="Driver Assignment Foundation" description="Transfer-to-driver assignment architecture. No live drivers. No public driver directory. Verification, GPS, and payouts are later phases." href="/admin/integrations/drivers" action="Open Driver Foundation" /><ModuleCard label="Verification & trust" title="Driver Verification Review" description="Private verification cases, evidence, and audit trail. No KYC provider is live. Approval cannot invent identity or liveness checks." href="/admin/integrations/verification" action="Open Verification" /></div>}
