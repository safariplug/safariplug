...
export default function ExperiencesPage() {
  return (
    <main className="min-h-screen bg-[#f7f7f4] text-[#111]">
      ...
      <DiscoverySwitcher current="/experiences" /><section className="mx-auto max-w-7xl px-5 pt-8 md:px-8"><Link href="/activities" className="flex flex-col justify-between gap-4 rounded-[1.75rem] border border-[#c9a86a]/20 bg-[#c9a86a]/5 p-6 sm:flex-row sm:items-center"><div><p className="text-[10px] font-black uppercase tracking-[.2em] text-[#9d793e]">Live supplier inventory</p><h2 className="mt-2 text-2xl font-semibold">Search bookable Hotelbeds activities</h2><p className="mt-2 text-sm text-black/50">Live tours, tickets and activities with governed SafariPlug checkout.</p></div><span className="font-bold text-[#9d793e]">Search live activities →</span></Link></section>
