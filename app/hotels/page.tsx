...
export default function HotelsPage() {
  ...
  async function search(event: FormEvent) {
    ...
    try {
      const params = new URLSearchParams({ destination: destination.trim(), check_in: checkIn, check_out: checkOut, guests, rooms, currency: "KES", location_scope: "specific" });
