        ...
        <div className="grid gap-10 lg:grid-cols-[1fr_380px]">
          <div className="space-y-8">
            ...
            <article className="rounded-3xl border border-white/10 bg-white/[0.05] p-8 shadow-xl">
              ...
              {event.venue_address && (
                <p className="text-white/40">{event.venue_address}</p>
              )}
            </article>
          ...
          <aside>
            <div className="sticky top-10 rounded-3xl border border-white/10 bg-white/[0.05] p-8 shadow-xl">
              ...
              <AddToTripButton eventId={event.id} tripId={tripId} />
              <SaveExperienceButton eventId={event.id} />
              <ShareButton
                title={event.title}
                text={`Check out ${event.title} on SafariPlug`}
              />
              {event.booking_url ? (
                <a
                  ...
                  className="mt-4 block rounded-full bg-[#e7c98d] px-6 py-4 text-center font-bold text-[#070708]"
                >
                  Get Tickets →
                </a>
              ) : event.source_url ? (
