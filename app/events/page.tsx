...
export default async function EventsPage({
  ...
  const selectedWhen = params.when || "upcoming";
  ...
  const eventList = allEvents.filter((event) => {
    return (
      matchesCity(event, selectedCity) &&
      matchesCategory(event, selectedCategory) &&
      matchesWhen(event, selectedWhen)
    );
  });
        ...
        {eventList.length === 0 ? (
          <div className="mt-10 rounded-3xl border border-dashed border-slate-300 bg-white p-12 text-center">
            ...
            <p className="mx-auto mt-3 max-w-lg text-slate-500">
              We could not find events matching those filters.
              Try another city, category or date range.
            </p>
                ...
                <div className="relative flex h-56 items-center justify-center overflow-hidden bg-slate-900">
                  {event.image_url ? (
                    ...
                    <div className="text-7xl">
                      {event.category === "Music & Nightlife"
                        ? "🎵"
                ...
                <div className="p-6">
                  <div className="flex items-center justify-between gap-3">
                    ...
                    <span className="text-xs font-semibold text-slate-400">
                      {event.venue_address || "East Africa"}
                    </span>
                  </div>
