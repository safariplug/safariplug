...
type State = { account?: { contact_name: string; onboarding_status: string; completion_percent: number }; business?: Record<string, any>; profile?: Record<string, any>; offerings?: Record<string, any>[]; suggestedOfferings?: SuggestedOffering[]; staff?: Staff[]; availability?: Availability[]; activationReadiness?: ActivationReadiness };
