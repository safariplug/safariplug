  ...
  return (
    <main className="min-h-screen bg-black text-white">
      ...
      <section className="flex min-h-[calc(100vh-81px)] items-center justify-center px-6 py-12"><div className="w-full max-w-2xl">
        ...
        <p className="mt-4 text-center text-sm"><Link href="/staff/login" className="font-semibold text-amber-400 hover:text-amber-300">Admin or staff? Open the operations portal →</Link></p>
      </div></section>
    </main>
  );
}
