...
export default function PartnerDashboardPage() {
  ...
  async function loadDashboard() {
    ...
    if (company) setBusiness(company.name);
      ...
      <section className="mx-auto max-w-6xl px-6 py-10">
        ...
        <div className="mt-8 grid gap-5 md:grid-cols-3">
          <div className="rounded-3xl bg-white p-6 shadow-sm">
            <p className="font-bold text-slate-400">TOTAL EXPERIENCES</p>
          ...
          <div className="rounded-3xl bg-white p-6 shadow-sm">
            <p className="font-bold text-slate-400">PENDING REVIEW</p>
        ...
        <div className="mt-8 grid gap-4 md:grid-cols-2">
          ...
          >
            <h3 className="text-xl font-black">My Experiences</h3>
            <p className="mt-2 text-slate-500">
          ...
          <Link
            ...
            className="rounded-3xl bg-white p-6 shadow-sm hover:shadow-md"
          >
            <h3 className="text-xl font-black">Add New Experience</h3>
            <p className="mt-2 text-slate-500">
