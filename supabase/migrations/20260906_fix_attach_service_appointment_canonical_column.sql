-- Fix the appointment-to-trip RPC to use the canonical trip_items.appointment_id relation.
-- The RPC is server-only; ownership is validated by the trusted server route before invocation,
-- and the function re-validates that the appointment and trip belong to p_traveler_id.
...
begin
  ...
  insert into public.trip_items (
    trip_id, appointment_id, item_kind, position,
