-- Keep service-payment webhook application server-only, search-path safe,
-- and monotonic across duplicate/out-of-order provider callbacks.
...
revoke all on function public.apply_service_payment_webhook(uuid,text,text,timestamptz,numeric)
from public, anon, authenticated;
grant execute on function public.apply_service_payment_webhook(uuid,text,text,timestamptz,numeric)
to service_role;
