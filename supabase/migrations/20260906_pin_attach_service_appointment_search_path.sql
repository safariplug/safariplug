-- Pin the SECURITY DEFINER RPC search path and keep it server-only.
...
begin
  ...
  where service_appointment_id = p_appointment_id
  limit 1;
  if found then
  ...
  insert into public.trip_items (
    trip_id, service_appointment_id, item_kind, position,
