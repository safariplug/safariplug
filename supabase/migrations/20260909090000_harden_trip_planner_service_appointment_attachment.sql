...
begin
  ...
  if v_appointment.trip_id is not null and v_appointment.trip_id <> p_trip_id then
  ...
  values (p_trip_id, p_appointment_id, 'service', v_appointment.title, v_appointment.starts_at, v_appointment.ends_at, v_position)
